...
class Stockaccount
{
	...
	//System.out.println("Enter the Company number you wish to buy or ");


		do
		{
			System.out.println("Enter the Symbol please in which want to perform your operation");
			String s1=sc.next();
			for(Object joo:ja)
			{
			...
			System.out.println(" you want to conti.");
			 user=sc.next();
